...
# This script meant to run in the specific Quickstart folder: C:\Users\DavidJones\source\repos\az-iothub-ps\PS\quickstarts\Telemetry\control-a-device
