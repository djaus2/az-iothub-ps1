#!/bin/bash
# This script is meant to run in Quickstarts. Assumed that is placed in /home/usr/
...
export EVENT_THUBS_COMPATIBILITY_ENDPOINT='sb://iothub-ns-dshub-2908772-b212bea2d9.servicebus.windows.net/'
