function do-setup{
    ...
    $options = 'A. Install Azure Cli using PowerShell,L. Az Cli Login,E. Install Az IOT Extension,U. Update Az IoT Extensions,R. Remove Az IOT Extensions,V. Az Verion and info'

    $options="$options,B. Back"
    do{
        parse-list 'EMPTY'   '  S E T U P   ' $options  $DeviceStrnIndex $DeviceStrnDataIndex 1  22 $Current
