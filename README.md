...
<hr>
There is now a device app under Telemetry that uses DHT22 sensor on a RPi. Only works on Raspian. For further info on that (eg Setup) see the repo: [djaus2/DNETCoreGPIO](https://github.com/djaus2/DNETCoreGPIO)
<hr>
